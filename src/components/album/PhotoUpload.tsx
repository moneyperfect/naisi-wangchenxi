  ...
  return (
    <div className="min-h-0 overflow-hidden">
      {items.length === 0 ? (
        ...
        <div className="flex min-h-0 flex-col gap-3" style={{ maxHeight: "calc(100dvh - 9rem)" }}>
          <div className="min-h-0 space-y-2 overflow-y-auto pr-1" style={{ maxHeight: "calc(100dvh - 17rem)" }}>
            {items.map((item) => (
              <div
                key={item.id}
